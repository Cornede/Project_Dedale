...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"Explorer"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo2={"Explorer"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		//Object [] entityParametersExplo3={"Explorer"};
		
		//4) Give the class name of your agent to let the system instantiate it
		//ag=createNewDedaleAgent(c, agentName, FSMExploAgent.class.getName(), entityParametersExplo3);//ExploreSoloAgent
