...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		//3) If you want to give specific parameters to your agent, add them here
		//To choose a random algorithm
		//String.valueOf(genRand())
		Object [] entityParametersExplo1={"Explorer", "0"};
		
		//4) Give the class name of your agent to let the system instantiate it
		//ag=createNewDedaleAgent(c, agentName,DummyMovingAgent.class.getName(), entityParametersExplo1);
		ag=createNewDedaleAgent(c, agentName, FSMExploAgent.class.getName(), entityParametersExplo1);//FSMAgent
		agentList.add(ag);
		...
		//To choose a random algorithm
		//String.valueOf(genRand())
		Object [] entityParametersExplo2={"Explorer", "0"};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, FSMExploAgent.class.getName(), entityParametersExplo2);//FSMAgent
		agentList.add(ag);
//		
//		
//		
...
//		 *********/
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, FSMExploAgent.class.getName(), entityParametersExplo3);//FSMAgent
		agentList.add(ag);
