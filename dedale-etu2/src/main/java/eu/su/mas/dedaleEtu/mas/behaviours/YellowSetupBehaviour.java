...
public class YellowSetupBehaviour extends SimpleBehaviour {
	...
	@Override
	public void action() {
		((FSMExploAgent) this.myAgent).setMode(this.behaviour);
		...
		//if (mode == 2) {
		//	Property state = new Property("Free", true);
		...
		try {
			...
			System.out.println("Hello I'm " + this.myAgent.getLocalName() + " and I registered myself as : " + this.behaviour);
